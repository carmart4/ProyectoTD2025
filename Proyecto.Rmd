...
# Funcion que almacena la informacion de la tienda y de los productos por factura. 
...
ExtraeInformacion <- function(lineas) {
    ...
    # Al final tenemos dos listas. 
    # Una es la lista con del encabezado, y la otra de los productos 
...
#productos <- DetectaParking(productos)[[1]] # Lista de productos con el parking descartado
...
RegistroFicheros <- function(Nombrepdf, DF_ficheros_noleidos, DF_ficheros_leidos, Tienda_leida) {
  ...
  if ((verifica[[1]] == FALSE) && !(Nombrepdf %in% DF_ficheros_noleidos$NombreFichero)) {
    ...
    informacion <- ExtraeInformacion(lineas)[[1]]
