...
diccionario_productos <- list(
  Fruta = c("plátano", "manzana", "pera", "naranja", "kiwi", "mango", "melón", "sandía", "fresa", "uva", "piña", "ciruela", "cereza", "granada", "banana"),
  Verdura = c("lechuga", "tomate", "cebolla", "zanahoria", "pimiento", "calabacín", "pepino", "espinaca", "acelga", "berenjena", "col", "brócoli"),
